...
//********************* */ It's just a demo for if you want to change anything in HTML Via react. **********************************
// const onChangeTitle = () => {
...
//********************* */ Below code is for changing a title without loading a entire page using {useState} *****************************
  // const [title, setTitle] = useState(document.title);

  // const onChangeTitle = () => {
    // setTitle(document.title = 'Hello Hiren');
  ...
  return (
    ...
    <section id="Contact" className="w-full py-12 md:py-24 lg:py-28 bg-muted">
      ...
      {/* <div className="flex justify-center items-center gap-10 py-6">
        ...
        {count}
        <Button size={"icon"} onClick={onPlus}>+</Button>
      </div>
      Button to change any content
      <Button variant={"default"} onClick={onChangeTitle}>Change the title</Button>
      {title} */}
    </section>
